...
| **Eq. (14.18)** | $\hat{v}_{t, d} = u_d^*(W)$ where $v_{\text{slack}} = 0$ | Unbiased Stochastic Supergradient Samples | `pkgmath.SolveLAPDual`<br>`LAPJVResult.U`, `LAPJVResult.V` | [`pkg/math/lap.go`](file:///Users/jacob/Development/od/project_mittens/pkg/math/lap.go) |
