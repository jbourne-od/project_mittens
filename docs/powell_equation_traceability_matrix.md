...
| **Eq. (14.18)** | $\hat{v}_{t, d} = u_d^{*, n}$ where $v_{\text{slack}} = 0$ | Normalized Sample-Path Supergradient Duals | `pkgmath.SolveLAPDual`<br>`LAPJVResult.U`, `LAPJVResult.V` | [`pkg/math/lap.go`](file:///Users/jacob/Development/od/project_mittens/pkg/math/lap.go) |
